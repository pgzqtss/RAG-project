  ...
  return(
    <div className='flex flex-col w-full'>
      <div className='flex w-full justify-start'>
        <button 
          className='text-sm w-[120px] p-2 mb-4 rounded-xl bg-gray-100 hover:bg-gray-200 transition hover:scale-105'
            ...
            {files.map((file, index) => (
              <li key={index} className='col-span-1'>
                <a href={`files/${id}/${file}`} target='_blank' rel='noopener noreferrer'>
                  <div
                    className='flex items-center justify-between w-full bg-gray-100 border-[1px] border-gray-200 rounded-xl py-1 px-2 hover:bg-gray-200'
                  >
